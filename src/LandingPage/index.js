        ...
        <div className="hero-section"  style={{ backgroundImage: `url(${myImage})` }}>
            <div className="animate-fade">
                ...
                <div className="flex flex-row justify-center items-center mt-4">
                    ...
                    <button className="mx-4 rounded-2xl bg-blue-600 bg-opacity-20 border-2 border-blue-500 p-4 hover:bg-opacity-100 hover:text-white text-color" onClick={() => window.location.href = 'https://docs.google.com/forms/d/e/1FAIpQLSelHxgkJB4Pfj9m-mmjW0G95VhoMBt47NHuk4-mnnpub9qQSQ/viewform?usp=dialog'}>Sponsor us</button>
                    <button className="mx-4 rounded-2xl bg-violet-600 bg-opacity-20 border-2 border-violet-500 p-4 hover:bg-opacity-100 hover:text-white text-color" onClick={() => window.location.href = 'mailto://team@mtgchallenge.org'}>Apply to Judge</button>
                </div>
            </div>
        </div>
        <ScrollAnimation>
        ...
        <div className="odd:bg-gray-950 my-4 py-8" id="home-about">
            <div className="mx-auto my-16">
                ...
                <div className="flex flex-row justify-center items-center space-x-2">
                    <img src={GlitchLogo} alt="Glitch Logo" className="h-[30px]"/>
                    <img src={WolframLogo} alt="Wolfram Logo" className="h-[30px]"/>
                    <img src={FlatlogicLogo} alt="Flatlogic Logo" className="h-[30px] rounded-full"/>
                </div>
            </div>
        </div>
